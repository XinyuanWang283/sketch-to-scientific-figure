...
The canonical review package for this case is [`editable_delivery_c_fidelity_v2/`](editable_delivery_c_fidelity_v2/README.md). Earlier deliveries remain decision history; they are not the active v0.1 pointer.
